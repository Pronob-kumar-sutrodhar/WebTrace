    ...
    <header className="border-b border-cyber-border/70 bg-[#0e1424]/90 dark:bg-[#0b0f19]/90 backdrop-blur-md sticky top-0 z-50 transition-colors shadow-lg shadow-black/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3.5">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-600 text-white flex items-center justify-center shadow-lg shadow-cyan-500/25 border border-cyan-400/40">
            <Network className="w-5 h-5 text-cyan-100" />
          </div>
          <div>
            <span className="font-pixel text-xs sm:text-sm tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-cyan-400 to-blue-400">
              WEBTRACE
            </span>
          </div>
        </div>
