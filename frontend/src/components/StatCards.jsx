  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="relative overflow-hidden bg-cyber-card/90 border border-cyber-border rounded-2xl p-5 shadow-lg backdrop-blur-md transition hover:border-cyan-500/50">
        ...
        <div className="text-2xl sm:text-3xl font-bold font-pixel text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-400">
          {stats.total_crawled}
        </div>
      ...
      {/* Directed Edges */}
      <div className="relative overflow-hidden bg-cyber-card/90 border border-cyber-border rounded-2xl p-5 shadow-lg backdrop-blur-md transition hover:border-blue-500/50">
        <div className="flex items-center justify-between text-slate-400 mb-2">
          <span className="text-xs font-semibold tracking-wide uppercase text-slate-300">Directed Edges</span>
          <div className="w-7 h-7 rounded-lg bg-blue-950/60 border border-blue-500/30 flex items-center justify-center">
            <ArrowRightLeft className="w-3.5 h-3.5 text-blue-400" />
          </div>
        </div>
        <div className="text-2xl sm:text-3xl font-bold font-pixel text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-400">
          {stats.graph_edges}
        </div>
